/**
 * Node.js NestJS - メインファイル（ルーティングのみ）
 * @nestjs/common を使用したシンプル実装
 */

const express = require('express');
const NestJSDatabase = require('./db');

const app = express();
const db = new NestJSDatabase();
...
// ヘルスチェック
app.get('/', (req, res) => {
  res.json({ message: 'Node.js NestJS API', status: 'OK' });
});
...
app.listen(PORT, () => {
  console.log(`Node.js NestJS サーバーが起動しました`);
